 ...
 */
exports.CRC_POLY = 0x08408;
/**
 * Bill to bill peripheral addresses.
 */
exports.ADR_BILL_TO_BILL = 0x01;
/**
 * Coin changer peripheral addresses.
 */
exports.ADR_COIN_CHANGER = 0x02;
/**
 * Bill validator peripheral addresses.
 */
exports.ADR_BILL_VALIDATOR = 0x03;
/**
 * Card reader peripheral addresses.
 */
exports.ADR_CARD_READER = 0x04;
/**
 * Indicates state of the bill validator and its activity.
 */
var DeviceStatus;
(function (DeviceStatus) {
    DeviceStatus[DeviceStatus["POWER_UP"] = 16] = "POWER_UP";
    DeviceStatus[DeviceStatus["POWER_UP_WITH_BILL_IN_VALIDATOR"] = 17] = "POWER_UP_WITH_BILL_IN_VALIDATOR";
    DeviceStatus[DeviceStatus["POWER_UP_WITH_BILL_IN_STACKER"] = 18] = "POWER_UP_WITH_BILL_IN_STACKER";
    /* ----------------------------------------------------------------------- */
    DeviceStatus[DeviceStatus["INITIALIZE"] = 19] = "INITIALIZE";
    DeviceStatus[DeviceStatus["IDLING"] = 20] = "IDLING";
    DeviceStatus[DeviceStatus["ACCEPTING"] = 21] = "ACCEPTING";
    DeviceStatus[DeviceStatus["STACKING"] = 23] = "STACKING";
    DeviceStatus[DeviceStatus["RETURNING"] = 24] = "RETURNING";
    DeviceStatus[DeviceStatus["UNIT_DISABLED"] = 25] = "UNIT_DISABLED";
    DeviceStatus[DeviceStatus["HOLDING"] = 26] = "HOLDING";
    DeviceStatus[DeviceStatus["DEVICE_BUSY"] = 27] = "DEVICE_BUSY";
    /* ----------------------------------------------------------------------- */
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_INSERTION"] = 2896] = "REJECTING_DUE_TO_INSERTION";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_MAGNETIC"] = 2897] = "REJECTING_DUE_TO_MAGNETIC";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_REMAINED_BILL_IN_HEAD"] = 2898] = "REJECTING_DUE_TO_REMAINED_BILL_IN_HEAD";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_MULTIPLYING"] = 2899] = "REJECTING_DUE_TO_MULTIPLYING";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_CONVEYING"] = 28100] = "REJECTING_DUE_TO_CONVEYING";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_IDENTIFICATION"] = 28101] = "REJECTING_DUE_TO_IDENTIFICATION";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_VERIFICATION"] = 28102] = "REJECTING_DUE_TO_VERIFICATION";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_OPTIC"] = 28103] = "REJECTING_DUE_TO_OPTIC";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_INHIBIT"] = 28104] = "REJECTING_DUE_TO_INHIBIT";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_CAPACITY"] = 28105] = "REJECTING_DUE_TO_CAPACITY";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_OPERATION"] = 28106] = "REJECTING_DUE_TO_OPERATION";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_LENGTH"] = 28108] = "REJECTING_DUE_TO_LENGTH";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_UNRECOGNISED_BARCODE"] = 28146] = "REJECTING_DUE_TO_UNRECOGNISED_BARCODE";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_UV"] = 28109] = "REJECTING_DUE_TO_UV";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_INCORRECT_NUMBER_OF_CHARACTERS_IN_BARCODE"] = 28147] = "REJECTING_DUE_TO_INCORRECT_NUMBER_OF_CHARACTERS_IN_BARCODE";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_UNKNOWN_BARCODE_START_SEQUENCE"] = 28148] = "REJECTING_DUE_TO_UNKNOWN_BARCODE_START_SEQUENCE";
    DeviceStatus[DeviceStatus["REJECTING_DUE_TO_UNKNOWN_BARCODE_STOP_SEQUENCE"] = 28149] = "REJECTING_DUE_TO_UNKNOWN_BARCODE_STOP_SEQUENCE";
    /* ----------------------------------------------------------------------- */
    DeviceStatus[DeviceStatus["DROP_CASSETTE_FULL"] = 65] = "DROP_CASSETTE_FULL";
    DeviceStatus[DeviceStatus["DROP_CASSETTE_OUT_OF_POSITION"] = 66] = "DROP_CASSETTE_OUT_OF_POSITION";
    DeviceStatus[DeviceStatus["VALIDATOR_JAMMED"] = 67] = "VALIDATOR_JAMMED";
    DeviceStatus[DeviceStatus["DROP_CASSETTE_JAMMED"] = 68] = "DROP_CASSETTE_JAMMED";
    DeviceStatus[DeviceStatus["CHEATED"] = 69] = "CHEATED";
    DeviceStatus[DeviceStatus["PAUSE"] = 70] = "PAUSE";
    /* ----------------------------------------------------------------------- */
    DeviceStatus[DeviceStatus["STACK_MOTOR_FAILURE"] = 7180] = "STACK_MOTOR_FAILURE";
    DeviceStatus[DeviceStatus["TRANSPORT_MOTOR_SPEED_FAILURE"] = 7181] = "TRANSPORT_MOTOR_SPEED_FAILURE";
    DeviceStatus[DeviceStatus["TRANSPORT_MOTOR_FAILURE"] = 7182] = "TRANSPORT_MOTOR_FAILURE";
    DeviceStatus[DeviceStatus["ALIGNING_MOTOR_FAILURE"] = 7183] = "ALIGNING_MOTOR_FAILURE";
    DeviceStatus[DeviceStatus["INITIAL_CASSETTE_STATUS_FAILURE"] = 7184] = "INITIAL_CASSETTE_STATUS_FAILURE";
    DeviceStatus[DeviceStatus["OPTIC_CANAL_FAILURE"] = 7185] = "OPTIC_CANAL_FAILURE";
    DeviceStatus[DeviceStatus["MAGNETIC_CANAL_FAILURE"] = 7186] = "MAGNETIC_CANAL_FAILURE";
    DeviceStatus[DeviceStatus["CAPACITANCE_CANAL_FAILURE"] = 7195] = "CAPACITANCE_CANAL_FAILURE";
    /* ----------------------------------------------------------------------- */
    DeviceStatus[DeviceStatus["ESCROW_POSITION"] = 128] = "ESCROW_POSITION";
    DeviceStatus[DeviceStatus["BILL_STACKED"] = 129] = "BILL_STACKED";
    DeviceStatus[DeviceStatus["BILL_RETURNED"] = 130] = "BILL_RETURNED";
})(DeviceStatus = exports.DeviceStatus || (exports.DeviceStatus = {}));
;
/**
 *
 */
exports.DeviceStatusMessage = new Map([
 ...
 *
 */
exports.DeviceStatusDescription = new Map([
